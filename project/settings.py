...
SECRET_KEY = 'django-insecure-6$mnyb+jqtk_c_!3-vk!er0qnql(_@7@!($h7jz1cj$8+dwbnx'
...
MAIN_ROLES = ["ГД", "ВД"] # Роли которые могут удалять или добавлять пользователей к договорам
